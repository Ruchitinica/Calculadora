...
import { StyleSheet, Text, View, disableYellowBox, TouchableHighlight, TouchableOpacity } from 'react-native';
    ...
    if(n == "="){
      let resultado = 0;
        if(sinal == "+"){
          ...
          resultadp = firstNumber-secondNumber;
        }
        else if(sinal == "/"){
          resultado = firstNumber/secondNumber;
        }
  ...
  return (
    <View style={{flex:1, backgroundColor:'black'}}>
     ...
     <View style={{flex:1,flexDirection:'row',height:'16.6%',alignItems:'center'}}>
      ...
      <View style={{flexDirection:'row',flexWrap:'wrap',borderColor:'black',borderTopWidth:2,height:'66.6%'}}>
        {
